$('document').ready(function(){
    ...
    $('.button').click(function(){
        ...
        $('#rightarea').empty();
        var cname= $(this).attr("data-filter");
        console.log(cname);
                  ...
                  if(cname==x[i].catname)  
                    {
                        ...
                        iDiv.style.backgroundColor='lightblue';
                    ...
                    //iDiv.innerHTML = x[i].catname +"<br>"+ x[i].title + "<br>"+ x[i].content + "<br>"+drawimg;
                      ...
                      iDiv.innerHTML = x[i].catname +"<br>"+ x[i].title + "<br>"+sliced + "</hr>" + "<button onclick='checkforlogin("+JSON.stringify(x[i])+")' type='button' class='btn btn-info btn-lg' data-toggle='modal' data-target='#mymodel' >Read More</button>";
